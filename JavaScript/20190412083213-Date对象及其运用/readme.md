...
date.getSeconds(); // 返回当前秒数 0-59
date.getMilliseconds(); // 返回当前的毫秒数
...
date.setHours(10); // 设置date中的小时 0-23，返回1970年1月1日到当前日期的毫秒数
date.setMinutes(30); // 设置date中的分钟 0-59，返回1970年1月1日到当前日期的毫秒数
date.setSeconds(30); // 设置date中的秒数 0-59，返回1970年1月1日到当前日期的毫秒数
date.setMilliseconds(120); // 设置date中的毫秒数，返回1970年1月1日到当前日期的毫秒数
